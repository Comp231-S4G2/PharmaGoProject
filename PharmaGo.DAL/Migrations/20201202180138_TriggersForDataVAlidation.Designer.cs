...
namespace PharmaGo.DAL.Migrations
{
    ...
    [Migration("20201202180138_TriggersForDataVAlidation")]
    partial class TriggersForDataVAlidation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaGo.BOL.MedDemand", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long>("CustomerPrescriptionId");
                    ...
                    b.HasIndex("CustomerPrescriptionId");

                    b.HasIndex("StockMedicineId");

                    b.ToTable("MedDemands");
                });
            ...
            modelBuilder.Entity("PharmaGo.BOL.MedDemand", b =>
                {
                    b.HasOne("PharmaGo.BOL.CustomerPrescription", "CustomerPrescription")
                        .WithMany("MedDemands")
                        .HasForeignKey("CustomerPrescriptionId")
                        .OnDelete(DeleteBehavior.Cascade);
